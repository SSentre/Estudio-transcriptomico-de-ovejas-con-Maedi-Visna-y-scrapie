...
El siguiente paso en nuestro análisis es realizar un análisis de gene ontology (GO) con la siguiente función:
```{r eval=FALSE, include=FALSE}
gn=unique(sample(keys(org.Oa.eg.db, "ENTREZID"), 4))
gg1=makeGOGraph(gn, "mf")
```


```{r eval=FALSE, include=FALSE}
basicProfile(genelist=fit.cont1, idType="GoTermsFrame", onto ="ANY", level=2, orgPackage=NULL)
```
